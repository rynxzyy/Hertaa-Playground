...
const { writeExif } = require('./utilities/exif');
            ...
            let mediaMessage = await config.prepareWAMessageMedia({
                ...(mime === 'image' ?
                    ...
                    } :
                    {
                        document: file.data,
                        mimetype: file.mime,
                        fileName: json.filename || 'NekoBot.' + extension(file.mime),
                    }),
            }, {
...
`.trim();
    ...
    sock.sendDocs = async (jid, text, m) => {
        ...
        await sock.sendMessage(jid, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: `Kecepatan Respon: ${latensi.toFixed(4)} Detik-!`
                }
            }
        }, { quoted: m });
    }
    ...
    sock.sendAsSticker = async (jid, path, quoted, options = {}) => {
		...
		await sock.sendMessage(jid, { sticker: { url: result }, ...options }, { quoted });
		return buff;
	}
