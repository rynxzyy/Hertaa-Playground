...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.pack.author ? global.pack.author : 'hertaa', b: data.packname ? data.packname : global.pack.name ? global.pack.name : 'hertaa', c: data.author ? data.author : global.pack.author ? global.pack.author : 'hertaa', d: data.categories ? data.categories : [""], e: data.isAvatar ? data.isAvatar : 0 }
